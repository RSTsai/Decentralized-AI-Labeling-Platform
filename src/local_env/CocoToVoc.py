...
if __name__ == '__main__':
    ...
    data_dir_default = './Data/Football\COCO_Football Pixel.json'
    xml_save_path_default = './Data/convert/voc'
    
    parser = argparse.ArgumentParser()
    parser.add_argument('-d', '--data-dir', type=str, default=data_dir_default, help='json path')
    parser.add_argument('-s', '--save-path', type=str, default=xml_save_path_default, help='xml save path')
    ...
    if len(sys.argv) > 1:
        ...
        xml_save_path = xml_save_path_default
